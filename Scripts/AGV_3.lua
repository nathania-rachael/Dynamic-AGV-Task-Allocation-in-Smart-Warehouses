-- Corrected AGV Script (for both AGVs)

function sysCall_init()
    agvName = "AGV_3" -- Change this to "AGV_2" for the second AGV
    ...
    dockHandle = sim.getObjectHandle("WP_15") -- dock for AGV_1
    ...
    wp15= sim.getObjectHandle("WP_15")
    wp18= sim.getObjectHandle("WP_18")
    
    routes = {
     {"Pickup_1", "Drop_1", {wp1}},
     {"Pickup_1", "Drop_2", {wp1, wp2}},
     {"Pickup_1", "Drop_3", {wp1, wp3}},
     {"Pickup_1", "Drop_4", {wp1, wp4}},
     
     {"Pickup_2", "Drop_1", {wp2, wp1}},
     {"Pickup_2", "Drop_2", {wp2}},
     {"Pickup_2", "Drop_3", {wp10, wp2, wp6, wp7}},
     {"Pickup_2", "Drop_4", {wp2, wp4}},
     
     {"Pickup_3", "Drop_1", {wp3, wp2, wp1}},
     {"Pickup_3", "Drop_2", {wp11,wp10,wp9,wp1,wp5,wp6}},
     {"Pickup_3", "Drop_3", {wp3}},
     {"Pickup_3", "Drop_4", {wp11, wp12, wp4, wp8}},
     
     {"Pickup_4", "Drop_1", {wp4, wp3, wp2, wp1}},
     {"Pickup_4", "Drop_2", {wp4, wp3, wp2}},
     {"Pickup_4", "Drop_3", {wp12, wp11, wp10,wp2,wp6,wp7}},
     {"Pickup_4", "Drop_4", {wp4}},
     ...
     {"Drop_2", "Pickup_4", {wp2, wp3, wp4}},
     
     {"Drop_3", "Pickup_1", {wp3, wp2, wp1}},
     {"Drop_3", "Pickup_2", {wp7, wp3, wp11, wp10}},
     {"Drop_3", "Pickup_3", {wp3}},
     ...
     -- Docking routes for AGV_3 (Drop -> WP_15)
     -- NOTE: wp15 included here so goToDock() does NOT need to append dockHandle
     {"Drop_1", "WP_15", {wp5, wp1, wp9, wp10,wp11,wp12,wp18,wp15}},
     {"Drop_2", "WP_15", {wp6, wp2, wp10,wp11,wp12,wp18,wp15}},
     {"Drop_3", "WP_15", {wp7, wp3,wp11,wp12,wp18,wp15}},
     {"Drop_4", "WP_15", {wp8, wp4, wp18,wp15}}
}
    routeDict = {}
...
function createFullRoute(task)
    ...
    -- find nearest zone (Pickup_x or Drop_x) to robot
...
-- GO TO DOCK: builds fullRoute using routeDict (WP_15 must be in dockRoute)
function goToDock(fromDrop)
    local key = fromDrop .. "|WP_15"
    ...
    if dockRoute then
        ...
        -- do NOT append dockHandle here ? the dock (wp15) should be included in dockRoute
        currentTarget = 1
        ...
        if currentTarget > #fullRoute then
            ...
            if currentTask then
                ...
                if returningToDock then
                    print(agvName .. " reached dock (WP_15) ? stopping and parked")
                    returningToDock = false
